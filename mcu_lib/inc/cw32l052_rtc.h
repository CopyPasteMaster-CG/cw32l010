...
#ifndef __CW32L052_RTC_H
#define __CW32L052_RTC_H
...
//============================================================
//  CW32L052 RTC HAL API Function（Total： 14），及所有位域的宏命令
//============================================================
...
int RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState);
int RTC_TamperTriggerConfig(uint32_t RTC_TamperTrigger);
int RTC_TamperCmd(FunctionalState NewState);
void RTC_GetTamperDate(RTC_DateTypeDef *RTC_Date);
void RTC_GetTamperTime(RTC_TimeTypeDef* RTC_TimeStruct);
int RTC_OutputConfig(uint8_t RTC_Output);
int RTC_AWTConfig(RTC_AWTTypeDef *RCT_AWTStruct);
int RTC_AWTCmd(FunctionalState NewState);
int RTC_SetInterval(uint8_t Period);
void RTC_SetClockSource(uint32_t RTC_ClockSource);
int RTC_CalibrationConfig(RTC_CalibTypeDef *RTC_CalibStruct);
int RTC_CalibrationCmd(FunctionalState NewState);
