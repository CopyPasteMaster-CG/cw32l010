 ...
 * @note     Generated by SVDConv V3.3.25 on Friday, 09.12.2022 16:47:19
 *           from File 'cw32l052.svd',
 *           last modified on Friday, 09.12.2022 08:47:06
 */
...
/* ==========================================  cw32l052 Specific Interrupt Numbers  ========================================== */
  ...
  BTIM2_LPTIM_IRQn          =  21,              /*!< 21 Base Timer2/LPTIM Interrupt                                            */
  ...
  AUTOTRIM_LCD_IRQn         =  30               /*!< 30 AUTOTRIM/LCD Interrupt                                                 */
} IRQn_Type;
...
//#include "system_cw32l052.h"                    /*!< cw32l052 System                                                           */
...
typedef struct {                                /*!< (@ 0x40012400) ADC Structure                                              */
  ...
  union {
    __IOM uint32_t ALTR;                        /*!< (@ 0x00000058) desc ALTR                                                  */
    
    struct {
      __IOM uint32_t CH0        : 1;            /*!< [0..0] desc CH0                                                           */
      __IOM uint32_t CH1        : 1;            /*!< [1..1] desc CH1                                                           */
      __IOM uint32_t CH2        : 1;            /*!< [2..2] desc CH2                                                           */
      __IOM uint32_t CH3        : 1;            /*!< [3..3] desc CH3                                                           */
      __IOM uint32_t CH4        : 1;            /*!< [4..4] desc CH4                                                           */
      __IOM uint32_t CH5        : 1;            /*!< [5..5] desc CH5                                                           */
      __IOM uint32_t CH6        : 1;            /*!< [6..6] desc CH6                                                           */
      __IOM uint32_t CH7        : 1;            /*!< [7..7] desc CH7                                                           */
      __IOM uint32_t CH8        : 1;            /*!< [8..8] desc CH8                                                           */
      __IOM uint32_t CH9        : 1;            /*!< [9..9] desc CH9                                                           */
      __IOM uint32_t CH10       : 1;            /*!< [10..10] desc CH10                                                        */
      __IOM uint32_t CH11       : 1;            /*!< [11..11] desc CH11                                                        */
      __IOM uint32_t CH12       : 1;            /*!< [12..12] desc CH12                                                        */
      __IOM uint32_t CH13       : 1;            /*!< [13..13] desc CH13                                                        */
      __IOM uint32_t CH14       : 1;            /*!< [14..14] desc CH14                                                        */
      __IOM uint32_t CH15       : 1;            /*!< [15..15] desc CH15                                                        */
      __IOM uint32_t REPEAT     : 1;            /*!< [16..16] desc REPEAT                                                      */
    } ALTR_f;
  } ;
  
  union {
    __IM  uint32_t RESULT;                      /*!< (@ 0x0000005C) desc RESULT                                                */
    
    struct {
      __IM  uint32_t RESULT     : 16;           /*!< [15..0] desc RESULT                                                       */
    } RESULT_f;
  } ;
} ADC_TypeDef;                                     /*!< Size = 96 (0x60)                                                          */
...
typedef struct {                                /*!< (@ 0x40012C00) ATIM Structure                                             */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t            : 1;
      __IOM uint32_t MODE       : 2;            /*!< [13..12] desc MODE                                                        */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t MSM        : 1;            /*!< [4..4] desc MSM                                                           */
...
typedef struct {                                /*!< (@ 0x40014C00) AUTOTRIM Structure                                         */
  ...
  union {
    __IM  uint32_t FCAP;                        /*!< (@ 0x00000080) desc FCAP                                                  */
  ...
  union {
    __IM  uint32_t TVAL;                        /*!< (@ 0x00000084) desc TVAL                                                  */
  ...
  union {
    __IM  uint32_t FLIM;                        /*!< (@ 0x00000088) desc FLIM                                                  */
...
typedef struct {                                /*!< (@ 0x40023000) CRC Structure                                              */
  ...
  union {
    __IOM uint32_t INIT;                        /*!< (@ 0x00000010) desc INIT                                                  */
...
typedef struct {                                /*!< (@ 0x40000400) GTIM1 Structure                                            */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t TI1XOR     : 1;            /*!< [21..21] desc TI1XOR                                                      */
      __IOM uint32_t IC1RST     : 1;            /*!< [22..22] desc IC1RST                                                      */
      __IOM uint32_t IC2RST     : 1;            /*!< [23..23] desc IC2RST                                                      */
      __IOM uint32_t IC3RST     : 1;            /*!< [24..24] desc IC3RST                                                      */
    } CR0_f;
  } ;
  ...
  union {
    __IOM uint32_t CCR4;                        /*!< (@ 0x0000032C) desc CCR4                                                  */
...
typedef struct {                                /*!< (@ 0x40002400) LCD Structure                                              */
  ...
  union {
    __IOM uint32_t ICR;                         /*!< (@ 0x00000008) desc ICR                                                   */
  ...
  union {
    ...
    struct {
      __IOM uint32_t SEG0       : 1;            /*!< [0..0] desc SEG0                                                          */
      __IOM uint32_t SEG1       : 1;            /*!< [1..1] desc SEG1                                                          */
      __IOM uint32_t SEG2       : 1;            /*!< [2..2] desc SEG2                                                          */
      __IOM uint32_t SEG3       : 1;            /*!< [3..3] desc SEG3                                                          */
      __IOM uint32_t SEG4       : 1;            /*!< [4..4] desc SEG4                                                          */
      __IOM uint32_t SEG5       : 1;            /*!< [5..5] desc SEG5                                                          */
      __IOM uint32_t SEG6       : 1;            /*!< [6..6] desc SEG6                                                          */
      __IOM uint32_t SEG7       : 1;            /*!< [7..7] desc SEG7                                                          */
      __IOM uint32_t SEG8       : 1;            /*!< [8..8] desc SEG8                                                          */
      __IOM uint32_t SEG9       : 1;            /*!< [9..9] desc SEG9                                                          */
      __IOM uint32_t SEG10      : 1;            /*!< [10..10] desc SEG10                                                       */
      __IOM uint32_t SEG11      : 1;            /*!< [11..11] desc SEG11                                                       */
      __IOM uint32_t SEG12      : 1;            /*!< [12..12] desc SEG12                                                       */
      __IOM uint32_t SEG13      : 1;            /*!< [13..13] desc SEG13                                                       */
      __IOM uint32_t SEG14      : 1;            /*!< [14..14] desc SEG14                                                       */
      __IOM uint32_t SEG15      : 1;            /*!< [15..15] desc SEG15                                                       */
      __IOM uint32_t SEG16      : 1;            /*!< [16..16] desc SEG16                                                       */
      __IOM uint32_t SEG17      : 1;            /*!< [17..17] desc SEG17                                                       */
      __IOM uint32_t SEG18      : 1;            /*!< [18..18] desc SEG18                                                       */
      __IOM uint32_t SEG19      : 1;            /*!< [19..19] desc SEG19                                                       */
      __IOM uint32_t SEG20      : 1;            /*!< [20..20] desc SEG20                                                       */
      __IOM uint32_t SEG21      : 1;            /*!< [21..21] desc SEG21                                                       */
      __IOM uint32_t SEG22      : 1;            /*!< [22..22] desc SEG22                                                       */
      __IOM uint32_t SEG23      : 1;            /*!< [23..23] desc SEG23                                                       */
      __IOM uint32_t SEG24VLCD1 : 1;            /*!< [24..24] desc SEG24VLCD1                                                  */
      __IOM uint32_t SEG25VLCD2 : 1;            /*!< [25..25] desc SEG25VLCD2                                                  */
      __IOM uint32_t SEG26VLCD3 : 1;            /*!< [26..26] desc SEG26VLCD3                                                  */
      __IOM uint32_t SEG27VLCD4 : 1;            /*!< [27..27] desc SEG27VLCD4                                                  */
      __IOM uint32_t SEG28COM7  : 1;            /*!< [28..28] desc SEG28COM7                                                   */
      __IOM uint32_t SEG29COM6  : 1;            /*!< [29..29] desc SEG29COM6                                                   */
      __IOM uint32_t SEG30COM5  : 1;            /*!< [30..30] desc SEG30COM5                                                   */
      __IOM uint32_t SEG31COM4  : 1;            /*!< [31..31] desc SEG31COM4                                                   */
    } PINEN1_f;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t SEG32      : 1;            /*!< [0..0] desc SEG32                                                         */
      __IOM uint32_t SEG33      : 1;            /*!< [1..1] desc SEG33                                                         */
      __IOM uint32_t SEG34      : 1;            /*!< [2..2] desc SEG34                                                         */
      __IOM uint32_t SEG35      : 1;            /*!< [3..3] desc SEG35                                                         */
      __IM  uint32_t            : 16;
      __IOM uint32_t SEG52      : 1;            /*!< [20..20] desc SEG52                                                       */
      __IOM uint32_t SEG53      : 1;            /*!< [21..21] desc SEG53                                                       */
      __IOM uint32_t SEG54      : 1;            /*!< [22..22] desc SEG54                                                       */
      __IOM uint32_t SEG55      : 1;            /*!< [23..23] desc SEG55                                                       */
      __IOM uint32_t COM0       : 1;            /*!< [24..24] desc COM0                                                        */
      __IOM uint32_t COM1       : 1;            /*!< [25..25] desc COM1                                                        */
      __IOM uint32_t COM2       : 1;            /*!< [26..26] desc COM2                                                        */
      __IOM uint32_t COM3       : 1;            /*!< [27..27] desc COM3                                                        */
...
typedef struct {                                /*!< (@ 0x40010000) SYSCTRL Structure                                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t PDRIVER    : 2;            /*!< [21..20] desc PDRIVER                                                     */
      __IOM uint32_t PFREQRANGE : 2;            /*!< [23..22] desc PFREQRANGE                                                  */
    } HSE_f;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t MODE       : 1;            /*!< [6..6] desc MODE                                                          */
      __IM  uint32_t            : 1;
      __IOM uint32_t PDRIVER    : 2;            /*!< [9..8] desc PDRIVER                                                       */
      __IOM uint32_t PAMP       : 2;            /*!< [11..10] desc PAMP                                                        */
      __IM  uint32_t            : 3;
      __IM  uint32_t STABLE     : 1;            /*!< [15..15] desc STABLE                                                      */
    } LSE_f;
  } ;
  ...
  union {
    __IOM uint32_t ATIMGATE;                    /*!< (@ 0x00000068) desc ATIMGATE                                              */
    
    struct {
      __IOM uint32_t ATIMGATE   : 3;            /*!< [2..0] desc ATIMGATE                                                      */
    } ATIMGATE_f;
  } ;
...
typedef struct {                                /*!< (@ 0x40013800) UART1 Structure                                            */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t SOURCE      : 2;            /*!< [9..8] desc SORCE                                                         */
  ...
  union {
    ...
    struct {
      __IOM uint32_t RFU        : 1;            /*!< [0..0] desc RFU                                                           */
      __IOM uint32_t TC         : 1;            /*!< [1..1] desc TC                                                            */
      __IOM uint32_t RC         : 1;            /*!< [2..2] desc RC                                                            */
      __IOM uint32_t FE         : 1;            /*!< [3..3] desc FE                                                            */
      __IOM uint32_t PE         : 1;            /*!< [4..4] desc PE                                                            */
...
/* =========================================================  ALTR  ========================================================== */
#define ADC_ALTR_REPEAT_Pos               (16UL)                    /*!< REPEAT (Bit 16)                                       */
#define ADC_ALTR_REPEAT_Msk               (0x10000UL)               /*!< REPEAT (Bitfield-Mask: 0x01)                          */
#define ADC_ALTR_CH15_Pos                 (15UL)                    /*!< CH15 (Bit 15)                                         */
#define ADC_ALTR_CH15_Msk                 (0x8000UL)                /*!< CH15 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH14_Pos                 (14UL)                    /*!< CH14 (Bit 14)                                         */
#define ADC_ALTR_CH14_Msk                 (0x4000UL)                /*!< CH14 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH13_Pos                 (13UL)                    /*!< CH13 (Bit 13)                                         */
#define ADC_ALTR_CH13_Msk                 (0x2000UL)                /*!< CH13 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH12_Pos                 (12UL)                    /*!< CH12 (Bit 12)                                         */
#define ADC_ALTR_CH12_Msk                 (0x1000UL)                /*!< CH12 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH11_Pos                 (11UL)                    /*!< CH11 (Bit 11)                                         */
#define ADC_ALTR_CH11_Msk                 (0x800UL)                 /*!< CH11 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH10_Pos                 (10UL)                    /*!< CH10 (Bit 10)                                         */
#define ADC_ALTR_CH10_Msk                 (0x400UL)                 /*!< CH10 (Bitfield-Mask: 0x01)                            */
#define ADC_ALTR_CH9_Pos                  (9UL)                     /*!< CH9 (Bit 9)                                           */
#define ADC_ALTR_CH9_Msk                  (0x200UL)                 /*!< CH9 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH8_Pos                  (8UL)                     /*!< CH8 (Bit 8)                                           */
#define ADC_ALTR_CH8_Msk                  (0x100UL)                 /*!< CH8 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH7_Pos                  (7UL)                     /*!< CH7 (Bit 7)                                           */
#define ADC_ALTR_CH7_Msk                  (0x80UL)                  /*!< CH7 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH6_Pos                  (6UL)                     /*!< CH6 (Bit 6)                                           */
#define ADC_ALTR_CH6_Msk                  (0x40UL)                  /*!< CH6 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH5_Pos                  (5UL)                     /*!< CH5 (Bit 5)                                           */
#define ADC_ALTR_CH5_Msk                  (0x20UL)                  /*!< CH5 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH4_Pos                  (4UL)                     /*!< CH4 (Bit 4)                                           */
#define ADC_ALTR_CH4_Msk                  (0x10UL)                  /*!< CH4 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH3_Pos                  (3UL)                     /*!< CH3 (Bit 3)                                           */
#define ADC_ALTR_CH3_Msk                  (0x8UL)                   /*!< CH3 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH2_Pos                  (2UL)                     /*!< CH2 (Bit 2)                                           */
#define ADC_ALTR_CH2_Msk                  (0x4UL)                   /*!< CH2 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH1_Pos                  (1UL)                     /*!< CH1 (Bit 1)                                           */
#define ADC_ALTR_CH1_Msk                  (0x2UL)                   /*!< CH1 (Bitfield-Mask: 0x01)                             */
#define ADC_ALTR_CH0_Pos                  (0UL)                     /*!< CH0 (Bit 0)                                           */
#define ADC_ALTR_CH0_Msk                  (0x1UL)                   /*!< CH0 (Bitfield-Mask: 0x01)                             */
/* ========================================================  RESULT  ========================================================= */
#define ADC_RESULT_RESULT_Pos             (0UL)                     /*!< RESULT (Bit 0)                                        */
#define ADC_RESULT_RESULT_Msk             (0xffffUL)                /*!< RESULT (Bitfield-Mask: 0xffff)                        */
...
/* ==========================================================  ETR  ========================================================== */
#define BTIMx_ETR_ETRFLT_Pos              (4UL)                     /*!< ETRFLT (Bit 4)                                        */
#define BTIMx_ETR_ETRFLT_Msk              (0x70UL)                  /*!< ETRFLT (Bitfield-Mask: 0x07)                          */
/* ==========================================================  CR  =========================================================== */
#define BTIMx_CR_TOGEN_Pos                (6UL)                     /*!< TOGEN (Bit 6)                                         */
#define BTIMx_CR_TOGEN_Msk                (0x40UL)                  /*!< TOGEN (Bitfield-Mask: 0x01)                           */
#define BTIMx_CR_ONESHOT_Pos              (5UL)                     /*!< ONESHOT (Bit 5)                                       */
#define BTIMx_CR_ONESHOT_Msk              (0x20UL)                  /*!< ONESHOT (Bitfield-Mask: 0x01)                         */
#define BTIMx_CR_POL_Pos                  (4UL)                     /*!< POL (Bit 4)                                           */
#define BTIMx_CR_POL_Msk                  (0x10UL)                  /*!< POL (Bitfield-Mask: 0x01)                             */
#define BTIMx_CR_TRS_Pos                  (3UL)                     /*!< TRS (Bit 3)                                           */
#define BTIMx_CR_TRS_Msk                  (0x8UL)                   /*!< TRS (Bitfield-Mask: 0x01)                             */
#define BTIMx_CR_MODE_Pos                 (1UL)                     /*!< MODE (Bit 1)                                          */
#define BTIMx_CR_MODE_Msk                 (0x6UL)                   /*!< MODE (Bitfield-Mask: 0x03)                            */
#define BTIMx_CR_EN_Pos                   (0UL)                     /*!< EN (Bit 0)                                            */
#define BTIMx_CR_EN_Msk                   (0x1UL)                   /*!< EN (Bitfield-Mask: 0x01)                              */
/* ==========================================================  IER  ========================================================== */
...
/* ==========================================================  CR0  ========================================================== */
#define GTIMx_CR0_IC3RST_Pos              (24UL)                    /*!< IC3RST (Bit 24)                                       */
#define GTIMx_CR0_IC3RST_Msk              (0x1000000UL)             /*!< IC3RST (Bitfield-Mask: 0x01)                          */
#define GTIMx_CR0_IC2RST_Pos              (23UL)                    /*!< IC2RST (Bit 23)                                       */
#define GTIMx_CR0_IC2RST_Msk              (0x800000UL)              /*!< IC2RST (Bitfield-Mask: 0x01)                          */
#define GTIMx_CR0_IC1RST_Pos              (22UL)                    /*!< IC1RST (Bit 22)                                       */
#define GTIMx_CR0_IC1RST_Msk              (0x400000UL)              /*!< IC1RST (Bitfield-Mask: 0x01)                          */
#define GTIMx_CR0_TI1XOR_Pos              (21UL)                    /*!< TI1XOR (Bit 21)                                       */
#define GTIMx_CR0_TI1XOR_Msk              (0x200000UL)              /*!< TI1XOR (Bitfield-Mask: 0x01)                          */
...
/* ==========================================================  ICR  ========================================================== */
#define LCD_ICR_INTF_Pos                  (12UL)                    /*!< INTF (Bit 12)                                         */
#define LCD_ICR_INTF_Msk                  (0x1000UL)                /*!< INTF (Bitfield-Mask: 0x01)                            */
/* ========================================================  PINEN1  ========================================================= */
#define LCD_PINEN1_SEG31COM4_Pos          (31UL)                    /*!< SEG31COM4 (Bit 31)                                    */
#define LCD_PINEN1_SEG31COM4_Msk          (0x80000000UL)            /*!< SEG31COM4 (Bitfield-Mask: 0x01)                       */
#define LCD_PINEN1_SEG30COM5_Pos          (30UL)                    /*!< SEG30COM5 (Bit 30)                                    */
#define LCD_PINEN1_SEG30COM5_Msk          (0x40000000UL)            /*!< SEG30COM5 (Bitfield-Mask: 0x01)                       */
#define LCD_PINEN1_SEG29COM6_Pos          (29UL)                    /*!< SEG29COM6 (Bit 29)                                    */
#define LCD_PINEN1_SEG29COM6_Msk          (0x20000000UL)            /*!< SEG29COM6 (Bitfield-Mask: 0x01)                       */
#define LCD_PINEN1_SEG28COM7_Pos          (28UL)                    /*!< SEG28COM7 (Bit 28)                                    */
#define LCD_PINEN1_SEG28COM7_Msk          (0x10000000UL)            /*!< SEG28COM7 (Bitfield-Mask: 0x01)                       */
#define LCD_PINEN1_SEG27VLCD4_Pos         (27UL)                    /*!< SEG27VLCD4 (Bit 27)                                   */
#define LCD_PINEN1_SEG27VLCD4_Msk         (0x8000000UL)             /*!< SEG27VLCD4 (Bitfield-Mask: 0x01)                      */
#define LCD_PINEN1_SEG26VLCD3_Pos         (26UL)                    /*!< SEG26VLCD3 (Bit 26)                                   */
#define LCD_PINEN1_SEG26VLCD3_Msk         (0x4000000UL)             /*!< SEG26VLCD3 (Bitfield-Mask: 0x01)                      */
#define LCD_PINEN1_SEG25VLCD2_Pos         (25UL)                    /*!< SEG25VLCD2 (Bit 25)                                   */
#define LCD_PINEN1_SEG25VLCD2_Msk         (0x2000000UL)             /*!< SEG25VLCD2 (Bitfield-Mask: 0x01)                      */
#define LCD_PINEN1_SEG24VLCD1_Pos         (24UL)                    /*!< SEG24VLCD1 (Bit 24)                                   */
#define LCD_PINEN1_SEG24VLCD1_Msk         (0x1000000UL)             /*!< SEG24VLCD1 (Bitfield-Mask: 0x01)                      */
#define LCD_PINEN1_SEG23_Pos              (23UL)                    /*!< SEG23 (Bit 23)                                        */
#define LCD_PINEN1_SEG23_Msk              (0x800000UL)              /*!< SEG23 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG22_Pos              (22UL)                    /*!< SEG22 (Bit 22)                                        */
#define LCD_PINEN1_SEG22_Msk              (0x400000UL)              /*!< SEG22 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG21_Pos              (21UL)                    /*!< SEG21 (Bit 21)                                        */
#define LCD_PINEN1_SEG21_Msk              (0x200000UL)              /*!< SEG21 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG20_Pos              (20UL)                    /*!< SEG20 (Bit 20)                                        */
#define LCD_PINEN1_SEG20_Msk              (0x100000UL)              /*!< SEG20 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG19_Pos              (19UL)                    /*!< SEG19 (Bit 19)                                        */
#define LCD_PINEN1_SEG19_Msk              (0x80000UL)               /*!< SEG19 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG18_Pos              (18UL)                    /*!< SEG18 (Bit 18)                                        */
#define LCD_PINEN1_SEG18_Msk              (0x40000UL)               /*!< SEG18 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG17_Pos              (17UL)                    /*!< SEG17 (Bit 17)                                        */
#define LCD_PINEN1_SEG17_Msk              (0x20000UL)               /*!< SEG17 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG16_Pos              (16UL)                    /*!< SEG16 (Bit 16)                                        */
#define LCD_PINEN1_SEG16_Msk              (0x10000UL)               /*!< SEG16 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG15_Pos              (15UL)                    /*!< SEG15 (Bit 15)                                        */
#define LCD_PINEN1_SEG15_Msk              (0x8000UL)                /*!< SEG15 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG14_Pos              (14UL)                    /*!< SEG14 (Bit 14)                                        */
#define LCD_PINEN1_SEG14_Msk              (0x4000UL)                /*!< SEG14 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG13_Pos              (13UL)                    /*!< SEG13 (Bit 13)                                        */
#define LCD_PINEN1_SEG13_Msk              (0x2000UL)                /*!< SEG13 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG12_Pos              (12UL)                    /*!< SEG12 (Bit 12)                                        */
#define LCD_PINEN1_SEG12_Msk              (0x1000UL)                /*!< SEG12 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG11_Pos              (11UL)                    /*!< SEG11 (Bit 11)                                        */
#define LCD_PINEN1_SEG11_Msk              (0x800UL)                 /*!< SEG11 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG10_Pos              (10UL)                    /*!< SEG10 (Bit 10)                                        */
#define LCD_PINEN1_SEG10_Msk              (0x400UL)                 /*!< SEG10 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN1_SEG9_Pos               (9UL)                     /*!< SEG9 (Bit 9)                                          */
#define LCD_PINEN1_SEG9_Msk               (0x200UL)                 /*!< SEG9 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG8_Pos               (8UL)                     /*!< SEG8 (Bit 8)                                          */
#define LCD_PINEN1_SEG8_Msk               (0x100UL)                 /*!< SEG8 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG7_Pos               (7UL)                     /*!< SEG7 (Bit 7)                                          */
#define LCD_PINEN1_SEG7_Msk               (0x80UL)                  /*!< SEG7 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG6_Pos               (6UL)                     /*!< SEG6 (Bit 6)                                          */
#define LCD_PINEN1_SEG6_Msk               (0x40UL)                  /*!< SEG6 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG5_Pos               (5UL)                     /*!< SEG5 (Bit 5)                                          */
#define LCD_PINEN1_SEG5_Msk               (0x20UL)                  /*!< SEG5 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG4_Pos               (4UL)                     /*!< SEG4 (Bit 4)                                          */
#define LCD_PINEN1_SEG4_Msk               (0x10UL)                  /*!< SEG4 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG3_Pos               (3UL)                     /*!< SEG3 (Bit 3)                                          */
#define LCD_PINEN1_SEG3_Msk               (0x8UL)                   /*!< SEG3 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG2_Pos               (2UL)                     /*!< SEG2 (Bit 2)                                          */
#define LCD_PINEN1_SEG2_Msk               (0x4UL)                   /*!< SEG2 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG1_Pos               (1UL)                     /*!< SEG1 (Bit 1)                                          */
#define LCD_PINEN1_SEG1_Msk               (0x2UL)                   /*!< SEG1 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN1_SEG0_Pos               (0UL)                     /*!< SEG0 (Bit 0)                                          */
#define LCD_PINEN1_SEG0_Msk               (0x1UL)                   /*!< SEG0 (Bitfield-Mask: 0x01)                            */
/* ========================================================  PINEN2  ========================================================= */
#define LCD_PINEN2_MUX_Pos                (28UL)                    /*!< MUX (Bit 28)                                          */
#define LCD_PINEN2_MUX_Msk                (0x10000000UL)            /*!< MUX (Bitfield-Mask: 0x01)                             */
#define LCD_PINEN2_COM3_Pos               (27UL)                    /*!< COM3 (Bit 27)                                         */
#define LCD_PINEN2_COM3_Msk               (0x8000000UL)             /*!< COM3 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN2_COM2_Pos               (26UL)                    /*!< COM2 (Bit 26)                                         */
#define LCD_PINEN2_COM2_Msk               (0x4000000UL)             /*!< COM2 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN2_COM1_Pos               (25UL)                    /*!< COM1 (Bit 25)                                         */
#define LCD_PINEN2_COM1_Msk               (0x2000000UL)             /*!< COM1 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN2_COM0_Pos               (24UL)                    /*!< COM0 (Bit 24)                                         */
#define LCD_PINEN2_COM0_Msk               (0x1000000UL)             /*!< COM0 (Bitfield-Mask: 0x01)                            */
#define LCD_PINEN2_SEG55_Pos              (23UL)                    /*!< SEG55 (Bit 23)                                        */
#define LCD_PINEN2_SEG55_Msk              (0x800000UL)              /*!< SEG55 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG54_Pos              (22UL)                    /*!< SEG54 (Bit 22)                                        */
#define LCD_PINEN2_SEG54_Msk              (0x400000UL)              /*!< SEG54 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG53_Pos              (21UL)                    /*!< SEG53 (Bit 21)                                        */
#define LCD_PINEN2_SEG53_Msk              (0x200000UL)              /*!< SEG53 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG52_Pos              (20UL)                    /*!< SEG52 (Bit 20)                                        */
#define LCD_PINEN2_SEG52_Msk              (0x100000UL)              /*!< SEG52 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG35_Pos              (3UL)                     /*!< SEG35 (Bit 3)                                         */
#define LCD_PINEN2_SEG35_Msk              (0x8UL)                   /*!< SEG35 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG34_Pos              (2UL)                     /*!< SEG34 (Bit 2)                                         */
#define LCD_PINEN2_SEG34_Msk              (0x4UL)                   /*!< SEG34 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG33_Pos              (1UL)                     /*!< SEG33 (Bit 1)                                         */
#define LCD_PINEN2_SEG33_Msk              (0x2UL)                   /*!< SEG33 (Bitfield-Mask: 0x01)                           */
#define LCD_PINEN2_SEG32_Pos              (0UL)                     /*!< SEG32 (Bit 0)                                         */
#define LCD_PINEN2_SEG32_Msk              (0x1UL)                   /*!< SEG32 (Bitfield-Mask: 0x01)                           */
/* =========================================================  RAM0  ========================================================== */
...
#define RAM_ADDR_ADDR_Msk                 (0x3fffUL)                /*!< ADDR (Bitfield-Mask: 0x3fff)                          */
/* ==========================================================  ISR  ========================================================== */
...
/* ==========================================================  HSE  ========================================================== */
#define SYSCTRL_HSE_PFREQRANGE_Pos        (22UL)                    /*!< PFREQRANGE (Bit 22)                                   */
#define SYSCTRL_HSE_PFREQRANGE_Msk        (0xc00000UL)              /*!< PFREQRANGE (Bitfield-Mask: 0x03)                      */
#define SYSCTRL_HSE_PDRIVER_Pos           (20UL)                    /*!< PDRIVER (Bit 20)                                      */
#define SYSCTRL_HSE_PDRIVER_Msk           (0x300000UL)              /*!< PDRIVER (Bitfield-Mask: 0x03)                         */
...
#define SYSCTRL_LSE_PAMP_Pos              (10UL)                    /*!< PAMP (Bit 10)                                         */
#define SYSCTRL_LSE_PAMP_Msk              (0xc00UL)                 /*!< PAMP (Bitfield-Mask: 0x03)                            */
#define SYSCTRL_LSE_PDRIVER_Pos           (8UL)                     /*!< PDRIVER (Bit 8)                                       */
#define SYSCTRL_LSE_PDRIVER_Msk           (0x300UL)                 /*!< PDRIVER (Bitfield-Mask: 0x03)                         */
...
#define UARTx_CR2_TIMCR_Msk               (0x1c00UL)                /*!< TIMCR (Bitfield-Mask: 0x07)                           */
#define UARTx_CR2_SOURCE_Pos               (8UL)                     /*!< SORCE (Bit 8)                                         */
#define UARTx_CR2_SOURCE_Msk               (0x300UL)                 /*!< SORCE (Bitfield-Mask: 0x03)                           */
...
#define UARTx_ICR_RFU_Pos                 (0UL)                     /*!< RFU (Bit 0)                                           */
#define UARTx_ICR_RFU_Msk                 (0x1UL)                   /*!< RFU (Bitfield-Mask: 0x01)                             */
/* =========================================================  ADDR  ========================================================== */
